...
## Page Structure Hero with portrait, moving service marquee, selected work, services, about, contact CTA, footer.
...
## Assets Profile photo will be added manually later; current portrait area is an unframed placeholder.
## Functionality Responsive navigation anchors, animated hero name, portrait entrance animation, marquee, scroll reveals, project hover motion, reduced-motion support, contact mailto CTA.
...
## Current Decisions Main CTA is “Let’s work together”. Services are Web Design, AI Automation, and Virtual Assistant. Target is small businesses/startups. The first screen should strongly resemble the supplied reference's composition: large name behind/above the person, person centered and overlapping the typography, with supporting role/copy and links around the portrait.
